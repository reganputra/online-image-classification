...
class MainActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        currentImageUri?.let { uri -> // pengecekan Uri
            val imageFile = uriToFile(uri, this).reduceFileImage()
            Log.d("Image Classification File", "showImage: ${imageFile.path}")
            showLoading(true)

            //  membuat RequestBody untuk data deskripsi dan berkas gambar
            ...
            // Mengirim Berkas ke Server dengan Retrofit
            lifecycleScope.launch { // menjalankan Coroutine di dalam Activity
                try {
